...
record Student(String name, int cps, Enrollment program) {
    /**
     //     * Check if a student is enrolled in Computer Science.
     //     *
     //     * @return {@code true}, if the student is enrolled in Computer Science, otherwise {@code
    //     *     false}
     //     */
    public boolean isIFM() {
        return program == Enrollment.IFM;
    }
    // The other methods gets automatically generated by the record class
}
